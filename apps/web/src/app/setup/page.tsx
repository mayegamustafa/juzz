...
type Status = 'checking' | 'available' | 'unavailable' | 'done';
        ...
        <div className="card p-8" style={{ borderTop: '3px solid #047857' }}>
          ...
          {status === 'unavailable' && (
            <div className="text-center">
              <h1 className="font-heading text-lg font-bold">Setup is not available</h1>
          ...
          {status === 'done' && (
            <div className="text-center">
              ...
              <h1 className="font-heading text-lg font-bold">Administrator account created</h1>
              <p className="mt-2 text-sm" style={{ color: 'var(--muted)' }}>
          ...
          {status === 'available' && (
            <>
              <h1 className="font-heading mb-1 text-center text-lg font-bold">First-run setup</h1>
